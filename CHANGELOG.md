...
- Updated separator to allow custom level titles.
...
- Updated cards grid behavior.

## 🚀 [1.2.2] - 2026-02-06

### 🔴 Fixed

- Remove / from i18n path.
...
- Initial project configuration, architecture and functionality.
